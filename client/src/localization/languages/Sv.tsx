...
export default {
  ...
  com_ui_capability_correction: 'Tillåter användaren att ge uppföljande rättelser', // Allows user to provide follow-up corrections
  ...
  com_ui_model: 'Modell', // Model
  com_ui_select_model: 'Välj en modell', // Select a model
  com_ui_use_prompt: 'Använd prompt', // Use prompt
  com_ui_prev: 'Föregående', // Prev
  com_ui_next: 'Nästa', // Next
  com_ui_prompt_templates: 'Prompt Mallar', // Prompt Templates
  com_ui_hide_prompt_templates: 'Dölj Prompt Mallar', // Hide Prompt Templates
  com_ui_showing: 'Visar', // Showing
  com_ui_of: 'av', // of
  ...
  com_ui_cancel: 'Avbryt', // Cancel
  com_ui_save: 'Spara', // Save
  com_ui_copy_to_clipboard: 'Kopiera till urklipp', // Copy to clipboard
  com_ui_copied_to_clipboard: 'Kopierat till urklipp', // Copied to clipboard
  com_ui_regenerate: 'Återskapa', // Regenerate
  ...
  com_auth_google_login: 'Logga in med Google', // Login with Google
  com_auth_facebook_login: 'Logga in med Facebook', // Login with Facebook
  com_auth_github_login: 'Logga in med Github', // Login with Github
  ...
  com_auth_password_required: 'Lösenord krävs', // Password is required
  com_auth_password_min_length: 'Lösenordet måste vara minst 8 tecken', // Password must be at least 8 characters
  com_auth_password_max_length: 'Lösenordet får inte vara längre än 128 tecken', // Password must be less than 128 characters
  com_auth_password_forgot: 'Glömt lösenord?', // Forgot Password?
  com_auth_password_confirm: 'Bekräfta lösenord', // Confirm password
  ...
  com_auth_already_have_account: 'Har du redan ett konto?', // Already have an account?
  com_auth_login: 'Logga in', // Login
  com_auth_reset_password: 'Återställ ditt lösenord', // Reset your password
  com_auth_click: 'Klicka', // Click
  ...
  com_auth_click_here: 'Klicka här', // Click here
  ...
  com_endpoint_default_empty: 'standard: tom', // default: empty
  com_endpoint_default_with_num: 'standard: {0}', // default: {0}
  com_endpoint_context: 'Kontext', // Context
  ...
  com_endpoint_plug_use_functions: 'Använd funktioner', // Use Functions
  ...
  com_endpoint_presets: 'förinställningar', // presets
  com_endpoint_preset_name: 'Förinställningsnamn', // Preset Name
  com_endpoint_new_topic: 'Nytt ämne', // New Topic
  com_endpoint: 'Slutpunkt', // Endpoint
  com_endpoint_hide: 'Dölj', // Hide
  com_endpoint_show: 'Visa', // Show
  com_endpoint_examples: ' Förinställningar', //  Presets
  com_endpoint_completion: 'Komplettering', // Completion
  com_endpoint_agent: 'Agent', // Agent
  com_endpoint_show_what_settings: 'Visa {0} inställningar', // Show {0} Settings
  ...
  com_endpoint_view_options: 'Visa alternativ', // View Options
  com_endpoint_save_convo_as_preset: 'Spara konversation som förinställning', // Save Conversation as Preset
  com_endpoint_my_preset: 'Min förinställning', // My Preset
  ...
  com_endpoint_config_value: 'Ange värde för', // Enter value for
  com_endpoint_config_key_name_placeholder: 'Ange API-nyckel först', // Set API key first
  com_endpoint_config_key_encryption: 'Din nyckel kommer att krypteras och raderas vid', // Your key will be encrypted and deleted at
  ...
  com_endpoint_config_key_google_vertex_ai: 'Aktivera Vertex AI', // Enable Vertex AI
  com_endpoint_config_key_google_vertex_api: 'API på Google Cloud, sedan', // API on Google Cloud, then
  ...
  com_nav_export_include_endpoint_options: 'Inkludera slutpunktsalternativ', // Include endpoint options
  com_nav_enabled: 'Aktiverad', // Enabled
  com_nav_not_supported: 'Stöds ej', // Not Supported
  com_nav_export_all_message_branches: 'Exportera alla grenar för meddelanden', // Export all message branches
  com_nav_export_recursive_or_sequential: 'Rekursiv eller sekventiell?', // Recursive or sequential?
  com_nav_export_recursive: 'Rekursiv', // Recursive
  com_nav_export_conversation: 'Exportera konversation', // Export conversation
  com_nav_theme: 'Tema', // Theme
  com_nav_theme_system: 'System', // System
  com_nav_theme_dark: 'Mörkt', // Dark
  com_nav_theme_light: 'Ljust', // Light
  com_nav_clear_all_chats: 'Rensa alla chattar', // Clear all chats
